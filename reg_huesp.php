...
<body>
  <div class="container d-flex justify-content-center align-items-center min-vh-100">
    <form class="row g-3 needs-validation p-4 rounded shadow" novalidate id="registro-cosas">
      ...
      <div class="col-md-6">
        ...
        <input type="number" class="form-control" id="numero-col">
      ...
      <div class="col-md-6">
        <label for="lugar" class="form-label">Lugar <span style="color: red;">*</span></label>
